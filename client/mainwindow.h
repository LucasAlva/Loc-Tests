...
public slots:
    ...
    void handleTankPivotRB();
    void handleTankPivotLB();
    ...
    void handleInitialExtend();
    void handleMaxExcavationArm();
    void handleMinExcavationArm();
    void handleMidExcavationArm();
    ...
    void handleClosedLoop(bool checked);
